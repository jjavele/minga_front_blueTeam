...
const Page = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((res) => {
                ...
                dispatch(setChapterData({ number: res.data.chapter.order, title: res.data.chapter.title, manga_id: res.data.chapter.manga_id }));
                setCounter(page - 1);
            })
    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center w-full gap-2">
            ...
            />
            <p className="text-center font-semibold lg:text-xl w-6 rounded-xl">{counter + 1}</p>
        </div>
    );
};
