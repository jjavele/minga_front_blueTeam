...
export default function Author() {
  ...
  if ( 0 <= mangas?.length && mangas?.length < 4 || mangas?.length == null) {
    return (
      <div className="flex flex-col justify-center items-center text-[8vh] bg-[#EBEBEB] rounded">
          <div className="h-[30vh] w-[90vw] flex justify-evenly items-center pt-10">
              ...
              <div className="">
                  <p className="text-[3.5vw] md:text-[2.5vw] xl:text-[2vw] font-bold capitalize" >{author?.name} {author?.last_name} </p>
                  <p className="text-[3.5vw] md:text-[2.5vw] xl:text-[2vw] flex items-center capitalize" ><spin><img src="/src/assets/images/location-marker.png" alt="location-marker" /></spin>{author?.city}, {author?.country} </p>
          ...
          <div className="flex flex-col justify-center items-center gap-6 md:gap-12 min-h-[55vh] w-full pb-32">
                <img className="w-[40vw] h-[50vw] md:w-[25vw] md:h-[30vw] xl:w-[18vw] xl:h-[23vw] object-contain rounded-[15px]]" src="/src/assets/images/minga-logo.png" alt={mangas} />
                <p className="text-[3.5vw] md:text-[2.5vw] xl:text-[2vw] font-bold capitalize text-[#4338CA]">No Manga Found</p>  
          </div>
          <div className="min-h-[10vh] w-full flex justify-center items-center pb-9">
  ...
  }else if ( 4 <= mangas?.length && mangas?.length < 8 ) {
    return (
      <div className="flex flex-col justify-center items-center text-[8vh] bg-[#EBEBEB] rounded">
          <div className="h-[30vh] w-[90vw] flex justify-evenly items-center pt-10">
              <img className="w-[10vh] h-[10vh] md:w-[15vh] md:h-[15vh] rounded-full object-fill object-center" src={author?.photo} alt="profile-picture" />
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12 min-h-[55vh] w-full hover:focus:placeholder:marker">
            {mangas && mangas.map((manga) => (
            <div key={manga._id } className="flex items-center justify-between border-gray-400 py-2">
              <div className="flex flex-col">
              <Anchor to="/mangas/:_id">
                <img className="w-[40vw] h-[50vw] md:w-[25vw] md:h-[30vw] xl:w-[18vw] xl:h-[23vw] object-cover rounded-[15px] shadow-[0px_2px_7px_0px_rgba(0,0,0,0.15)]" src={manga.cover_photo} alt={mangas.cover_photo} />
              </Anchor>
