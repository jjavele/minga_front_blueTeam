        ...
        <div className='flex h-[525px] flex-col items-center sm:items-start gap-8 self-stretch'>
          ...
          <div className='flex flex-row items-center text-center lg:justify-between sm:w-[400px] w-[250px]'>
            ...
            <div className='flex flex-col ms-3'>
              <p className='text-[14px] text-[#fff]'>mail@gmail.com</p>
            </div>
          ...
          <div className='lg:text-lg'>
            <Anchor>
              <p className='p-3 hover:bg-white text-[#fff] hover:text-[#4338CA] w-[250px] sm:w-[400px] rounded-md'>Home</p>
            </Anchor>
            <Anchor to="/">
              <p className='p-3  hover:bg-white text-[#fff] hover:text-[#4338CA] w-[250px] sm:w-[400px] rounded-md'>Register</p>
            </Anchor>
            <Anchor to="/login">
              <p className='p-3  hover:bg-white text-[#fff] hover:text-[#4338CA] w-[250px] sm:w-[400px] rounded-md'>Log in</p>
            </Anchor>
            {role == 1 || role == 2 ? (
              <>
                <Anchor to="/manga-form" > <p className='p-3  hover:bg-white text-[#fff] hover:text-[#4338CA] w-[250px] sm:w-[400px] rounded-md'>Naw Manga</p></Anchor>
                <Anchor to="/chapter-form"><p className='p-3  hover:bg-white text-[#fff] hover:text-[#4338CA] w-[250px] sm:w-[400px] rounded-md'>New Chapter</p>
                </Anchor>
              </>
            ) : ("")}
          </div>
