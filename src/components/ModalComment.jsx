...
let ModalComment = ({ isOpen, onClose, chapterId, page }) => {
    ...
    let getComments = (page) => {
        dispatch(commentsActions.datos_comments({chapterId, page}))
    }
    
    useEffect(() => {
        getComments(page)
        dispatch(commentsActions.datos_comments({ chapterId, page: currentPage}))
    }, [isOpen, chapterId, page, currentPage]);
    ...
    let handleSubmit = async (event) => {
        ...
        dispatch(commentsActions.post_comment({ chapter_id: chapterId, user_id: user._id, comment: newComment }))
        setNewComment('')
        //onClose();
    };
