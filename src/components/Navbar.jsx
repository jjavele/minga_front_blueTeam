    ...
    <nav>
      <div>
        <div className="flex w-full justify-between p-5 absolute">
            <button onClick={toggleNavbar} className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-800 focus:bg-gray-800 focus:text-white transition duration-300 ease-in-out">
